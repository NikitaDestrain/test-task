...
public class RecipeDTOFactory {
    public static RecipeDTO create(Long id, String description, PatientDTO patient, DoctorDTO doctor, Date creationDate, Date expirationDate, PriorityDTO priority) {
